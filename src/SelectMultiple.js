...
const itemType = PropTypes.oneOfType([
  ...
  PropTypes.shape({
    label: PropTypes.any,
    value: PropTypes.any,
    checkboxSource: PropTypes.any | sourceType,
    selectedCheckboxSource: PropTypes.any | sourceType,
  }),
]);
...
export default class SelectMultiple extends Component {
  static propTypes = {
    ...
    useCheckboxSourceFromItem: PropTypes.bool,
  ...
  static defaultProps = {
    ...
    labelStyle: {},
    maxSelect: null,
    useCheckboxSourceFromItem: false,
  ...
  toLabelValueObject(obj) {
    if (Object.prototype.toString.call(obj) === "[object String]") {
      ...
      return {
        label: obj.label,
        value: obj.value,
        checkboxSource: obj.checkboxSource,
        selectedCheckboxSource: obj.selectedCheckboxSource,
      };
    }
  }
